// === Bagian 1: Penanganan error saat mengakses array ===
try {
  let mahasiswa = ["Andi", "Budi", "Citra"];
  console.log(mahasiswa[5].toUpperCase()); // Indeks 5 tidak ada
} catch (error) {
...
// === Bagian 2: Penanganan error dengan fungsi cekUsia ===
...
// === Bagian 3: Membuat class error khusus (ValidasiError) ===
...
function cekNama(nama) {
  ...
  // perbaikan di sini: string literal harus pakai backtick (``)
